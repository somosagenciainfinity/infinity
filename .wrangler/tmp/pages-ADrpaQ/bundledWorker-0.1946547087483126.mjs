...
var Ne = /* @__PURE__ */ __name((e, t, r) => t.has(e) || ze("Cannot " + r), "Ne");
var d = /* @__PURE__ */ __name((e, t, r) => (Ne(e, t, "read from private field"), r ? r.call(e) : t.get(e)), "d");
var m = /* @__PURE__ */ __name((e, t, r) => t.has(e) ? ze("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), "m");
...
var Ue = /* @__PURE__ */ __name((e, t, r, s) => ({ set _(o) {
  f(e, t, o, r);
}, get _() {
  return d(e, t, s);
} }), "Ue");
...
var qt = nt;
var zt = /* @__PURE__ */ __name((e, t) => nt(e, t, true), "zt");
...
}, ae = /* @__PURE__ */ new WeakMap(), O = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakSet(), dt = /* @__PURE__ */ __name(function(e) {
...
var Ut = { Stringify: 1 };
var pt = /* @__PURE__ */ __name(async (e, t, r, s, o) => {
...
var Vt = (Je = class {
  ...
  constructor(e, t) {
    ...
    g(this, "html", (e2, t2, r) => {
      const s = /* @__PURE__ */ __name((o) => x(this, z, re).call(this, o, t2, Me("text/html; charset=UTF-8", r)), "s");
...
var gt = (Ye = class {
  ...
  route(t, r) {
    ...
    return r.routes.map((o) => {
      var i;
      let a;
      r.errorHandler === Be ? a = o.handler : (a = /* @__PURE__ */ __name(async (l, n) => (await Ge([], r.errorHandler)(l, () => o.handler(l, n))).res, "a"), a[Kt] = o.handler), x(i = s, j, W).call(i, o.method, o.path, a);
    }), this;
  }
  basePath(t) {
  ...
  mount(t, r, s) {
    let o, a;
    s && (typeof s == "function" ? a = s : (a = s.optionHandler, s.replaceRequest === false ? o = /* @__PURE__ */ __name((n) => n, "o") : o = s.replaceRequest));
    const i = a ? (n) => {
      const c = a(n);
    ...
    const l = /* @__PURE__ */ __name(async (n, c) => {
  ...
  throw t;
}, "ke"), Ae = /* @__PURE__ */ __name(function(t, r, s, o) {
...
}, U = /* @__PURE__ */ new WeakMap(), G = /* @__PURE__ */ new WeakMap(), de = /* @__PURE__ */ new WeakSet(), vt = /* @__PURE__ */ __name(function() {
...
}, B = /* @__PURE__ */ new WeakMap(), P = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap(), ce = /* @__PURE__ */ new WeakMap(), T = /* @__PURE__ */ new WeakMap(), H = /* @__PURE__ */ new WeakSet(), K = /* @__PURE__ */ __name(function(e, t, r, s) {
  const o = [];
...
var hs = /* @__PURE__ */ __name(async (e, t) => {
  let r;
...
var fs = /* @__PURE__ */ __name((e) => async function(r, s) {
  return ps({ ...e, getContent: /* @__PURE__ */ __name(async (a) => hs(a, { manifest: e.manifest, namespace: e.namespace ? e.namespace : r.env ? r.env.__STATIC_CONTENT : void 0 }), "getContent") })(r, s);
}, "fs");
...
// ../.wrangler/tmp/bundle-SVGyc0/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-SVGyc0/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.1946547087483126.mjs.map
