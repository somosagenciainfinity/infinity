...
</html>`));S.get("/test-variant-fix",e=>e.html(`<!DOCTYPE html>
<html>
<head>
...
<body class="p-8">
  ...
  `));const ue=new Se,Tt=Object.assign({"/src/index.tsx":S});let Ce=!1;for(const[,e]of Object.entries(Tt))e&&(ue.route("/",e),ue.notFound(e.notFoundHandler),Ce=!0);if(!Ce)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{ue as default};
